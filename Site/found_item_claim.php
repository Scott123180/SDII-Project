...
<div class="container">
    ...
    <p>The contact information for the person who lost the item is below. Please email them in order to give them their item. Thanks for using Marist's Limbo DB!</p>
    <?php
